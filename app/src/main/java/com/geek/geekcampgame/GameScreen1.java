...
public class GameScreen1 extends AppCompatActivity {
    ...
    final String CORRECT_WORD = "ФРАНЦИЯ";
        ...
        btnCheckWord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().toString().equals(CORRECT_WORD)) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(GameScreen1.this);
                    ...
                    letter12.setVisibility(View.VISIBLE);
                    editText.setText("");
                    Toast.makeText(getBaseContext(), "Не правильно \uD83D\uDC4E\uD83C\uDFFB!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
